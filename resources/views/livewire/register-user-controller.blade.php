<form wire:submit.prevent="store" class="w-full p-6 h-full grid grid-cols-2 gap-4 justify-center">
    ...
    <div class="w-full">
        ...
        <x-text-input id="firstname" class="block mt-1 w-full" type="text" wire:model.live="firstname" placeholder="First name" required autofocus />
    ...
    <div class="w-full">
        ...
        <x-text-input id="middlename" class="block mt-1 w-full" type="text" wire:model.live="middlename" placeholder="Middle name" />
    ...
    <div class="w-full">
        ...
        <x-text-input id="lastname" class="block mt-1 w-full" type="text" wire:model.live="lastname" placeholder="Last name" required />
    ...
    <div class="w-full">
        ...
        <x-text-input id="extensionname" class="block mt-1 w-full" type="text" wire:model.live="extensionname" placeholder="Suffix (Sr., Jr. III., etc)" />
    ...
    <div class="w-full">
        ...
        <x-text-input id="email" class="block mt-1 w-full" type="email" wire:model.live="email" placeholder="user@cvsu.edu.ph" required />
    ...
    <div class="w-full">
        ...
        <select id="college_id" class="block mt-1 w-full rounded-lg border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500 @error('college_id') border-red-500 @enderror" wire:model.live="college_id">
    ...
    <div class="w-full">
        ...
        <select id="position" class="block mt-1 w-full rounded-lg border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500 @error('position') border-red-500 @enderror" wire:model.live="position">
    ...
    <div class="w-full">
        ...
        <x-text-input id="teaching_started_at" class="block mt-1 w-full" type="date" wire:model.live="teaching_started_at" max="{{ now()->toDateString() }}" required />
    ...
    <div class="w-full relative">
        ...
        <div class="relative">
            <x-text-input id="password" class="block mt-1 w-full pr-10" type="password" wire:model.live="password" required autocomplete="new-password" />
            <button type="button"
    ...
    <div class="w-full relative">
        ...
        <div class="relative">
            <x-text-input id="password_confirmation" class="block mt-1 w-full pr-10" type="password" wire:model.live="password_confirmation" required autocomplete="new-password" />
            <button type="button"
                class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-600 hover:text-gray-900 mt-1"
