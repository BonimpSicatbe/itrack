<div class="flex h-full bg-gray-50">
    ...
    <div class="w-1/3 border-r border-gray-200 bg-white rounded-lg overflow-y-auto">
        <div class="sticky top-0 z-10 p-4" style="background: linear-gradient(148deg,rgba(18, 67, 44, 1) 0%, rgba(30, 119, 77, 1) 54%, rgba(55, 120, 64, 1) 100%);">
            <div class="flex justify-between items-center">
                ...
                <button 
                    ...
                    class="text-sm text-white hover:text-gray-200 font-medium px-3 py-1.5 rounded-md bg-white/10 hover:bg-white/20 transition-colors border border-white/20"
                >
    ...
    <div class="w-2/3 p-6 overflow-y-auto bg-white">
        @if ($selectedNotification && $selectedNotificationData)
            <div class="max-w-3xl mx-auto space-y-4">
                ...
                <div class="bg-[#DEF4C6]/30 p-4 rounded-lg border border-[#73E2A7]/50">
                    <div class="flex">
                ...
                <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-gray-600 bg-gray-50 p-3 rounded-md border">{{ $selectedNotificationData['requirement']['description'] }}</p>
                        </div>
                        @endisset
                        ...
                        <div>
                            ...
                            <div class="flex items-center bg-orange-100 px-3 py-2 rounded-lg">
                ...
                @isset($selectedNotificationData['requirement'])
                <div class="bg-gradient-to-r from-[#DEF4C6]/20 to-[#73E2A7]/10 p-5 rounded-lg border border-[#73E2A7]/30">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <button 
                            ...
                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#1C7C54] to-[#1B512D] text-white rounded-lg hover:from-[#1B512D] hover:to-[#1C7C54] transition-all duration-200 font-medium text-sm shadow-lg hover:shadow-xl transform hover:scale-[1.02] justify-center"
                        >
                ...
                <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                    <div class="flex items-center justify-between mb-4 p-3 rounded-lg" style="background: linear-gradient(to right, #DEF4C6/20, #73E2A7/10);">
