...
<div class="h-screen flex flex-col lg:flex-row transition-all duration-300 ease-in-out">
    ...
    <div class="flex-1 bg-white rounded-lg shadow-sm overflow-hidden animate-in slide-in-from-left-5 fade-in duration-500">
        {{-- Detail Header --}}
        ...
        {{-- Detail Content --}}
        <div class="flex-1 overflow-y-auto p-6" style="max-height: calc(100vh - 120px);">
