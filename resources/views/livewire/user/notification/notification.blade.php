...
<div>
    ...
    <div class="h-screen flex flex-col lg:flex-row transition-all duration-300 ease-in-out">
        ...
        <div class="@if($selectedNotification && $selectedNotificationData) flex-1 @else w-full @endif bg-white rounded-lg shadow-sm overflow-hidden mb-4 lg:mb-0 @if($selectedNotification && $selectedNotificationData) lg:mr-4 @endif transition-all duration-300 ease-in-out">
            ...
            <div class="flex-1 overflow-y-auto p-4 scrollbar-hide" style="max-height: calc(100vh - 160px); scrollbar-width: none; -ms-overflow-style: none;">
                <div class="space-y-2">
        ...
        <div class="flex-1 bg-white rounded-lg shadow-sm flex flex-col animate-in slide-in-from-left-5 fade-in duration-500">
            ...
            {{-- Detail Content - Single scrollable area with hidden scrollbar --}}
            <div class="flex-1 overflow-y-auto notification-scroll scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                <div class="p-6 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                    <div class="max-w-4xl mx-auto space-y-6 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
