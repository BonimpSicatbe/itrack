<div class="flex flex-col w-full mx-auto min-h-screen text-sm overflow-hidden">
    ...
    <div wire:poll.5s class="w-full bg-white rounded-xl p-6 space-y-4 grow overflow-y-auto"
        ...
        <div class="p-1 rounded-xl flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <div class="relative w-sm">
                    ...
                    <input id="searchInput" type="text" wire:model.live.debounce.300ms="search"
                    ...
                    <button wire:click="$set('search', '')" onclick="document.getElementById('searchInput').value = ''"
                        class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer text-gray-500 hover:text-gray-700"
                        title="Clear search" x-show="$wire.search.length > 0" x-transition>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4">
                <!-- Status Filter -->
                <div
                    class="flex items-center gap-1 bg-white/80 p-1 rounded-xl font-semibold border border-gray-300 shadow-sm">
                    <button
                ...
                <div
                    ...
                    <div class="collapse-title">
                        <div class="flex flex-row items-center gap-8">
                            <div class="text-sm font-bold"><i
                                    class="fa-solid fa-clipboard-list min-w-[20px] text-center text-green-500"></i>
                                {{ $requirement->name }}</div>
                            <div class="text-xs text-gray-500 grow">{{ $requirement->due->format('M j, Y h:i A') }}
                            </div>
