<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 p-4">
    @if($currentSemester)
        ...
        @if($daysRemaining <= 7 && $daysRemaining > 0)
            <div class="mt-3 flex items-center gap-2 p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg border-l-4 border-orange-400">
        ...
        @elseif($daysRemaining <= 0)
            <div class="mt-3 flex items-center gap-2 p-2 bg-red-100 dark:bg-red-900/30 rounded-lg border-l-4 border-red-400">
    ...
    @else
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center justify-center w-10 h-10 bg-gray-100 dark:bg-gray-600 rounded-lg">
                <i class="fas fa-calendar-times text-gray-500 dark:text-gray-400"></i>
            </div>
            <div>
                <h3 class="font-semibold text-gray-700 dark:text-gray-300">No Active Semester</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Contact administrator to set up semester</p>
            </div>
        </div>
    @endif
</div>