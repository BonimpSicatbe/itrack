<div class="px-6 py-4 stats stats-vertical sm:stats-horizontal shadow text-white rounded-xl" style="background: linear-gradient(148deg,rgba(18, 67, 44, 1) 0%, rgba(30, 119, 77, 1) 54%, rgba(55, 120, 64, 1) 100%);">
