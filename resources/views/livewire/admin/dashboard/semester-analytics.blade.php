            ...
            <div class="card-body">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Top performing users by file-based completion rate</p>
                    </div>
                </div>
                        ...
                        <table class="table w-full">
                            <thead>
                                <tr class="border-b-2 border-gray-100">
                                    ...
                                    <th class="text-center font-semibold text-gray-700 bg-green-200">Submitted Files</th>
                                    <th class="text-center font-semibold text-gray-700 bg-green-200">Approved Files</th>
                                    <th class="text-center font-semibold text-gray-700 bg-green-200">Requirements</th>
                                    <th class="text-center font-semibold text-gray-700 bg-green-200 rounded-tr-xl">Completion Rate</th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td class="text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                @elseif($user['completion_rate'] >= 50)
                                                    <div class="tooltip" data-tip="Good progress!">
