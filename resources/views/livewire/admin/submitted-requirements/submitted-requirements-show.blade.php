            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button wire:click="updateStatus" 
                        class="inline-flex items-center px-3 py-1.5 text-sm font-medium rounded-full shadow-sm text-white bg-1C7C54 hover:bg-1B512D focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-1B512D">
                        Update
                    </button>
                </div>
            </div>
