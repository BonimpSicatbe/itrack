    ...
    <div class="w-full h-full bg-cover bg-center min-h-screen min-w-screen"
        ...
        <div class="w-full h-full flex flex-col items-end justify-center min-h-screen p-4 md:p-12">
            <div class="flex items-center justify-center w-full sm:w-2/3 md:w-1/2 lg:w-1/3 bg-white shadow rounded-lg h-full max-w-md mx-auto">
                <form method="POST" action="{{ $isAccountSetup ? route('password.update') : route('password.store') }}" 
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-1 relative">
                            <x-text-input 
                                id="password" 
                                class="block w-full pl-3 pr-10 py-3" 
                                type="password" 
                                name="password" 
                                required 
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <button type="button" class="text-gray-400 hover:text-gray-600 focus:outline-none password-toggle" data-target="password">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-1 relative">
                            ...
                            />
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <button type="button" class="text-gray-400 hover:text-gray-600 focus:outline-none password-toggle" data-target="password_confirmation">
                                    <i class="fa-solid fa-eye"></i>
                                </button>
                            </div>
                        </div>
